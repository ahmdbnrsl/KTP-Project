...
export default function LoginPage() {
    return (
        <section className="w-full min-h-screen relative flex flex-col justify-center items-center">
            <Image
                src="https://img.freepik.com/free-photo/abstract-blue-geometric-shapes-background_24972-1841.jpg?t=st=1728616015~exp=1728619615~hmac=ac681583930fc2802a7913f2a1b7e5edb9afee301f968b15e017a427ee97b026&w=740"
                width={1200}
                height={1200}
                ...
                alt="bg"
            />
            <main className="w-full min-h-screen bg-zinc-100 flex flex-col justify-center items-center absolute z-[10]">
                <div className="w-full max-w-md py-6 px-5 rounded-xl bg-zinc-100 border-2 border-zinc-300 shadow-2xl shadow-zinc-500 lg:flex lg:flex-row-reverse lg:max-w-5xl lg:p-0">
                    <div className="flex justify-center w-full lg:w-2/3 border-l-2 border-zinc-300">
                        <Image
                            src="/logo/auth.png"
                            alt="logo"
                            width={960}
                    ...
                    <hr className="mt-6 lg:hidden"></hr>
